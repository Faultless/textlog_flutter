/// The IANA top-level domain list, as the server's `tlds` package provides it to
/// linkify-it. Needed so a bare `github.com/stagas` links the way it does on the
/// site while `etc.` in the middle of a sentence does not.
///
/// Punycode (`xn--`) entries are left out: nothing in a 280-character post is going
/// to use one without a scheme.
library;
...
const tlds = <String>{
  ...
  'xbox', 'xerox', 'xihuan', 'xin', 'xxx', 'xyz', 'yachts', 'yahoo', 'yamaxun', 'yandex', 'ye', 'yodobashi',
  'yoga', 'yokohama', 'you', 'youtube', 'yt', 'yun', 'za', 'zappos', 'zara', 'zero', 'zip', 'zm',
  'zone', 'zuerich', 'zw',
};
